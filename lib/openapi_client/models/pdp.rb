...
module OpenapiClient
  class PDP
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'opal_token')
        self.opal_token = attributes[:'opal_token']
      end
    end
    ...
    def hash
      [name, id, project_id, environment_id, client_secret, opal_token].hash
    end
